...
class SettingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        submit.layer.backgroundColor = UIColor(red: (154/255), green: (216/255), blue: (153/255), alpha: 1).cgColor// Do any additional setup after loading the view, typically from a nib.
    }
